...
public class UserDAO extends DAO {
	...
	public boolean isHalfWidth(String value) {
	...
	public boolean loginCheckResult(
		...
		return isHalfWidth(id)
		        && user != null
		        && !LoginManager.isLoggedIn(id);
	}
...
//	}
	...
	public boolean insertUser(UserBean userBean)
	    ...
	    try (
	    	...
	    	st.setString(3, userBean.getFirstName());
	    	st.setString(4, userBean.getLastName());
	    	st.setString(5, userBean.getAddress());
	    	st.setString(6, userBean.getMailAddress());
	    	st.setString(7, "user");
